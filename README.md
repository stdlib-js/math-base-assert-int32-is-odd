...
```javascript
isOdd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-int32-is-odd@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-int32-is-odd@umd/bundle.js"></script>
```
